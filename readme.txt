...
1. Add TaksManagement source code folder to server root directory.
2. create database db_task_assignment and Import the database.txt file in that database. 
...
3. Click on the login button and login to application using the user you registered
